      ...
      >
        <div className="bg-card rounded-3xl shadow-2xl p-8 border border-border">
          ...
          <button
            ...
            disabled={submitting}
            className="w-full flex items-center justify-center gap-3 border-2 border-border rounded-full py-3 font-medium text-sm hover:bg-muted transition-colors mb-6 disabled:opacity-50"
          >
